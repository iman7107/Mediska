...
namespace Mediska.Models
{
    ...
    public partial class SupportContext : DbContext
    {
        ...
        public virtual ObjectResult<spCheckOffCode_Result> spCheckOffCode(string offCode)
        {
            var offCodeParameter = offCode != null ?
                new ObjectParameter("OffCode", offCode) :
                new ObjectParameter("OffCode", typeof(string));

            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spCheckOffCode_Result>("spCheckOffCode", offCodeParameter);
        }
